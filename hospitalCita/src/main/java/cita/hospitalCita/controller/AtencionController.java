...
public class AtencionController {
    ...
    public ResponseEntity<AtencionDetalleDTO> detalle(@PathVariable Integer id) {
        ...
        e.printStackTrace(); // <--- ESTO te mostrará la falla real en la consola de VS Code
        return ResponseEntity.internalServerError().build(); // Cambia a 500 provisionalmente
    }
}
